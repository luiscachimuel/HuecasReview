...
class ReviewsUseCase {
    ...
    suspend fun getAllRestaurantsApi(
        ...
        try {
            ...
            resp.addAll(newsList)
            return resp
        } catch (e: Exception){
            val context: Context = Adoptame.appContext
            val alertDialog: AlertDialog.Builder = AlertDialog.Builder(context)
            alertDialog.setTitle("Error de conexión!")//for set Title
            alertDialog.setMessage("No se puede conectar al API de restaurantes.")// for Message
        }
